...
void HardFault_Handler(void)
{
	...
	// Анализ причин BusFault
	if (cfsr & (1 << 0))  { /* IBUSERR: Instruction Bus Error */ }
	if (cfsr & (1 << 1))  { /* PRECISERR: Precise Data Bus Error */ }
	if (cfsr & (1 << 2))  { /* IMPRECISERR: Imprecise Data Bus Error */ }
